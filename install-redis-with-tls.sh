...
yum install devtoolset-9-binutils -y
yum install openssl-devel* -y
yum install openssl -y
echo WWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWW
scl enable devtoolset-9 bash
echo DDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDD
echo "source /opt/rh/devtoolset-9/enable" >> /etc/profile
echo QQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQ
